...
def login(request):
    if request.method not in ['GET', 'POST']:
        return JsonResponse({'ok': False, 'message': 'Method Not Allowed.'}, statud=405)
    ...
    if request.method == 'GET':
        ...
        request.session['session_public_key'] = session_public_key
        request.session['session_private_key'] = session_private_key
        context = {
